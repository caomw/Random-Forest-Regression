#ifndef LINPACK_D_H
#define LINPACK_D_H 1

// http://people.sc.fsu.edu/~jburkardt/cpp_src/linpack_d/linpack_d.html
...
void dgesl ( double a[], int lda, int n, int ipvt[], double b[], int job ); // solves a real general linear system A * X = B.
